...
export const valuationRows: ValuationRow[] = [
  ...
  { key: "ocf-market-cap", label: "OCF / diluted market cap", actual: "operatingCashToMarketCap", forward: "forwardOperatingCashToMarketCap", kind: "yield" },
  { key: "fcf-market-cap", label: "FCF / diluted market cap", actual: "fcfToMarketCap", forward: "forwardFcfToMarketCap", kind: "yield" },
